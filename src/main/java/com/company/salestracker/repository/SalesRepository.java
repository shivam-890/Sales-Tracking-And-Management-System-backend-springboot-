...
public interface SalesRepository extends JpaRepository<Sale, String> {
      ...
      List<Sale> findByOwnerUserIdAndCommissionUserUserIdAndPaymentStatusAndSaleDateBetween(String owner,String userId,PaymentStatus paymentstatus,LocalDate start,LocalDate end);
